<template>
  <div>
    <div
      ...
      :class="[
        props.theme.name,
        colorThemeStore.currentThemeIndex ===
        colorThemeStore.colorThemes.indexOf(props.theme)
          ? 'border-4 border-helper'
          : 'border-4 border-transparent',
      ]"
      @click="
        colorThemeStore.selectTheme(
          colorThemeStore.colorThemes.indexOf(props.theme)
        )
      "
    >
      ...
      <h2 class="">{{ props.theme.name }}</h2>
      <div class="flex gap-1">
        <div class="size-4 rounded-full bg-sub"></div>
